#!/usr/bin/env python3
"""
Least frequently used caching replacement protocol
"""
...
class LFUCache(BaseCaching):
    """
    LFU caching replacement protocol:
    ...
    def put(self, key, item):
        ...
        while removing the least frequently used
        item
        """
    ...
    def get(self, key):
        """
        Get method returns the item listed by key
        """
